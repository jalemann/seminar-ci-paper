...
Where $r$ again represents the number of the alternatives rank and $x$ is the number of responsible agents of the population. Selfish agents receive no Borda points off of responsible agents' votes because responsible agents rank other responsible agents higher than selfish agents. This way the reputation constraint which is represented by a voting history is used to reduce the Borda score of selfish agents even when they always rank themselves first.
\newline
