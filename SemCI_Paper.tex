...
Arrow's Impossibility Theorem\cite{arrow2012social} for example states that no rank-order voting mechanisms can be designed to be completely fair.
...
Arrow's Impossibility Theorem is of great importance for the design of a voting mechanisms. It states that there cannot be a completely fair rank-order voting system. Meaning that every voting system that has the properties of unanimity and independece of irrelevant alternatives also contains a dictator which vote decides the preference of the society as a whole.
